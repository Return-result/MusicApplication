...
//            openUrl(GITHUB);
            ...
            intent.setData(Uri.parse("mailto:resultreturn0@gmail.com"));
            intent.putExtra(Intent.EXTRA_EMAIL, "resultreturn0@gmail.com");
            intent.putExtra(Intent.EXTRA_SUBJECT, "PausePlay Music");
